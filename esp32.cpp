...
float temp=0.00;  //guarda la conversión del sensor de temperatura
int solicitar=0;
...
{
  Serial.begin(115200);
  Serial2.begin(115200); //PASAR DE 9600 A 115200 para comunicación UART2
...
void loop()
{
  //Parte 1 - Comunicación con el Sensor y el ESP32
   ...
   temp = ((sensor*3.3/4096)*(1/0.1))+22;   //conversicón de temp.
