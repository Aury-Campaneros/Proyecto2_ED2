...
void setup()
{
  ...
  LCD_Print(text1, 0, 100, 2, 0x00, 0xFFFFFF);
...
void loop()
{
  ...
  //Mostrar en pantalla 
  int recibir1=recibir*1000;
  int decena= recibir1/1000;
  recibir1=recibir1-(decena*1000);
  int unidad=recibir1/100;
  recibir1=recibir1-(unidad*100);
  int decimal=recibir1/10;
  recibir1=recibir1-(decimal*10);
  int decimal2=recibir1;
  String uno= String(decena);
  String dos= String(unidad);
  String tres= String(decimal);
  String cuatro= String(decimal2);
  String stringOne= uno + dos +"."+ tres + cuatro;
  LCD_Print(stringOne, 50, 120, 2, 0x00, 0xFFFFFF);
